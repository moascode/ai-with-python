...
class TestGaussianClass(unittest.TestCase):
    def setUp(self):
        ...
        self.gaussian.read_data_file('./ai-with-python/python/oop/package/distributions/numbers.txt')
...
class TestBinomialClass(unittest.TestCase):
    def setUp(self):
        ...
        self.binomial.read_data_file('./ai-with-python/python/oop/package/distributions/numbers_binomial.txt')
